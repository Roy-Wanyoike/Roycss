// Package blocks is the Go stub for the "blocks" RoyCSS platform module.
//
// Blocks routes — /api/v1/blocks
//
// Status: STUB — mirrors backend-node/src/modules/blocks.
...
// RegisterRoutes mounts the blocks module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/blocks", notImplemented)
	mux.HandleFunc("/api/v1/blocks/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"blocks"}}`))
}
