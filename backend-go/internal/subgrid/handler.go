// Package subgrid is the Go stub for the "subgrid" RoyCSS platform module.
//
// Subgrid routes — /api/v1/subgrid
//
// Status: STUB — mirrors backend-node/src/modules/subgrid.
...
// RegisterRoutes mounts the subgrid module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/subgrid", notImplemented)
	mux.HandleFunc("/api/v1/subgrid/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"subgrid"}}`))
}
