// Package analytics is the Go stub for the "analytics" RoyCSS platform module.
//
// Analytics routes — /api/v1/analytics
//
// Status: STUB — mirrors backend-node/src/modules/analytics.
...
// RegisterRoutes mounts the analytics module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/analytics", notImplemented)
	mux.HandleFunc("/api/v1/analytics/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"analytics"}}`))
}
