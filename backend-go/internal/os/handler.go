// Package os is the Go stub for the "os" RoyCSS platform module.
//
// OS routes — /api/v1/os
//
// Status: STUB — mirrors backend-node/src/modules/os.
...
// RegisterRoutes mounts the os module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/os", notImplemented)
	mux.HandleFunc("/api/v1/os/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"os"}}`))
}
