 ...
 * EVERY catalog id (all 1,983 URLs stay indexable), while build-time
 ...
 * (src/app/sitemap.ts) so all 1,983 /effects/<id> URLs stay listed.
 *
 ...
 *     Enumerating all 1,983 ids here previously produced 1,959
