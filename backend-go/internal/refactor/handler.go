// Package refactor is the Go stub for the "refactor" RoyCSS platform module.
//
// Refactor routes — /api/v1/refactor
//
// Status: STUB — mirrors backend-node/src/modules/refactor.
...
// RegisterRoutes mounts the refactor module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/refactor", notImplemented)
	mux.HandleFunc("/api/v1/refactor/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"refactor"}}`))
}
