// Package academy is the Go stub for the "academy" RoyCSS platform module.
//
// Academy routes — /api/v1/academy
//
// Status: STUB — mirrors backend-node/src/modules/academy.
...
// RegisterRoutes mounts the academy module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/academy", notImplemented)
	mux.HandleFunc("/api/v1/academy/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"academy"}}`))
}
