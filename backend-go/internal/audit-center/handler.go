// Package auditcenter is the Go stub for the "audit-center" RoyCSS platform module.
//
// Audit Center routes — /api/v1/audit-center
//
// Status: STUB — mirrors backend-node/src/modules/audit-center.
...
// RegisterRoutes mounts the audit-center module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/audit-center", notImplemented)
	mux.HandleFunc("/api/v1/audit-center/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"audit-center"}}`))
}
