// Package governance is the Go stub for the "governance" RoyCSS platform module.
//
// Governance routes — /api/v1/governance
//
// Status: STUB — mirrors backend-node/src/modules/governance.
...
// RegisterRoutes mounts the governance module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/governance", notImplemented)
	mux.HandleFunc("/api/v1/governance/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"governance"}}`))
}
