// Package procomponents is the Go stub for the "pro-components" RoyCSS platform module.
//
// Pro Components routes — /api/v1/pro-components
//
// Status: STUB — mirrors backend-node/src/modules/pro-components.
...
// RegisterRoutes mounts the pro-components module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/pro-components", notImplemented)
	mux.HandleFunc("/api/v1/pro-components/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"pro-components"}}`))
}
