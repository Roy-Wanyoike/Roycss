// Package profiler is the Go stub for the "profiler" RoyCSS platform module.
//
// Profiler routes — /api/v1/profiler
//
// Status: STUB — mirrors backend-node/src/modules/profiler.
...
// RegisterRoutes mounts the profiler module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/profiler", notImplemented)
	mux.HandleFunc("/api/v1/profiler/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"profiler"}}`))
}
