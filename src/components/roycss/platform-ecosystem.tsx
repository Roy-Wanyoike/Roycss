...
const DIFFERENTIATORS: Differentiator[] = [
  ...
  },
  {
    ...
    description: "14 CSS shapes (circle, star, heart, hexagon, arrow) with visual clip-path polygon editor and border-radius sliders.",
    icon: Frame,
  },
  {
    id: "scroll-snap",
    name: "Scroll Snap Builder",
    description: "Interactive scroll-snap-type/align builder with live scrollable preview and 4 presets.",
    icon: MoveVertical,
  },
  {
    id: "keyframes-studio",
    name: "Keyframes Studio",
    description: "Visual @keyframes editor with timeline stops, per-stop transform/color controls, live preview, 6 presets.",
    icon: Clapperboard,
  },
  {
    id: "theming-engine",
    name: "Theming Engine",
    description: "Design token generator from a single primary color — 12 OKLCH tokens, 3 export formats, WCAG contrast checks.",
    icon: Droplet,
  },
  {
    id: "has-selector-tester",
    name: ":has() Selector Tester",
    description: "Live DOM tree builder with real querySelectorAll matching, 6 preset scenarios, highlight matching elements. Baseline 2023.",
    icon: ScanSearch,
  },
  {
    id: "css-layers",
    name: "CSS Layers Visualizer",
    description: "@layer cascade visualizer with add/reorder layers, live preview via scoped style injection, priority diagram.",
    icon: Layers3,
  },
  {
    id: "input-mode",
    name: "Input Mode Explorer",
    description: "inputmode + enterkeyhint + autocomplete explorer with stylized keyboard mockups and reference tables.",
    icon: Keyboard,
  },
  {
    id: "cascade-specificity",
    name: "Cascade Specificity Explorer",
    description: "CSS parser + specificity computer with :where() stripping, cascade resolution visualization, 3 presets.",
    icon: Scale,
  },
  {
    id: "color-space",
    name: "Color Space Explorer",
    description: "Convert colors between sRGB, HSL, OKLCH, OKLab, Display-P3. Gamut visualization, 2D chroma-lightness plane, copy-ready CSS with sRGB fallback.",
    icon: Palette,
  },
  {
    id: "style-query",
    name: "Container Style Query Builder",
    description: "Build @container style(--foo: value) queries (Baseline 2023) with live container custom-property switching and 3 presets.",
    icon: Boxes,
  },
  {
    id: "scope",
    name: "@scope Rule Tester",
    description: "Playground for CSS @scope (Baseline 2024) with DOM tree builder, scope-root + scope-limit selectors, donut-scope visualization.",
    icon: Target,
  },
  {
    id: "subgrid",
    name: "Subgrid Builder",
    description: "Visual builder for grid-template-columns: subgrid (Baseline 2023). Parent track definitions inherited by nested grids with aligned track lines.",
    icon: Grid3x3,
  },
  {
    id: "fallback",
    name: "Property Fallback Analyzer",
    description: "Generate progressive-enhancement CSS with @supports feature queries for 20 modern properties. Old syntax → @supports → modern syntax chain.",
    icon: ShieldQuestion,
  },
  {
    id: "logical-properties",
    name: "Logical Properties Mapper",
    description: "Map physical → logical CSS properties (margin-left → margin-inline-start). RTL/vertical writing-mode demo, paste-physical-get-logical converter.",
    icon: ArrowLeftRight,
  },
  {
    id: "initial-letter",
    name: "Initial Letter Studio",
    description: "Design CSS initial-letter drop caps (Baseline 2024). Size/sink sliders, raised vs sunken caps, 3-way comparison with legacy float hack, 6 presets.",
    icon: CaseSensitive,
  },
  {
    id: "text-wrap",
    name: "Text Wrap Balance Studio",
