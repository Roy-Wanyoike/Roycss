// Package textwrap is the Go stub for the "text-wrap" RoyCSS platform module.
//
// Text-wrap routes — /api/v1/text-wrap
//
// Status: STUB — mirrors backend-node/src/modules/text-wrap.
...
// RegisterRoutes mounts the text-wrap module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/text-wrap", notImplemented)
	mux.HandleFunc("/api/v1/text-wrap/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"text-wrap"}}`))
}
