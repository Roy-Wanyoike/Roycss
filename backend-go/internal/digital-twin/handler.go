// Package digitaltwin is the Go stub for the "digital-twin" RoyCSS platform module.
//
// Digital Twin routes — /api/v1/digital-twin
//
// Status: STUB — mirrors backend-node/src/modules/digital-twin.
...
// RegisterRoutes mounts the digital-twin module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/digital-twin", notImplemented)
	mux.HandleFunc("/api/v1/digital-twin/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"digital-twin"}}`))
}
