// Package review is the Go stub for the "review" RoyCSS platform module.
//
// Review routes — /api/v1/review
//
// Status: STUB — mirrors backend-node/src/modules/review.
...
// RegisterRoutes mounts the review module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/review", notImplemented)
	mux.HandleFunc("/api/v1/review/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"review"}}`))
}
