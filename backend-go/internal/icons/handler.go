// Package icons is the Go stub for the "icons" RoyCSS platform module.
//
// Icons routes — /api/v1/icons
//
// Status: STUB — mirrors backend-node/src/modules/icons.
...
// RegisterRoutes mounts the icons module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/icons", notImplemented)
	mux.HandleFunc("/api/v1/icons/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"icons"}}`))
}
