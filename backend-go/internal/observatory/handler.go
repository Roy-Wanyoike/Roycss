// Package observatory is the Go stub for the "observatory" RoyCSS platform module.
//
// Observatory routes — /api/v1/observatory
//
// Status: STUB — mirrors backend-node/src/modules/observatory.
...
// RegisterRoutes mounts the observatory module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/observatory", notImplemented)
	mux.HandleFunc("/api/v1/observatory/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"observatory"}}`))
}
