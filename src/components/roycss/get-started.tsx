...
export function GetStarted() {
  ...
  return (
    <section id="get-started" aria-label="Get started with RoyCSS" className="py-16 sm:py-20 relative overflow-hidden scroll-mt-20">
              ...
              {(isOpen, onToggle) => (
                <>
                  ...
                  <AccordionContent isOpen={isOpen}>
                    ...
                    <CodeBlock title={`list — browse all ${EFFECT_COUNT_FORMATTED} effects`} icon={ListPlus} code={`npx roycss list\nnpx roycss list animations\nnpx roycss list --json`} />
                  </AccordionContent>
                </>
              )}
            </AccordionItem>
                ...
                <>
                  <AccordionTrigger isOpen={isOpen} onToggle={onToggle}>
                    <StepHeader
                      ...
                      icon={FileCode2}
                      hint={`Type roycss- + Tab to insert any of the ${EFFECT_COUNT_FORMATTED} effects instantly.`}
                    />
                  </AccordionTrigger>
                  <AccordionContent isOpen={isOpen}>
                ...
                <>
                  <AccordionTrigger isOpen={isOpen} onToggle={onToggle}>
                    <StepHeader
                      ...
                      icon={BrainCircuit}
                      hint={`Give Claude, Cursor, and Windsurf access to all ${EFFECT_COUNT_FORMATTED} effects — no hallucination.`}
                    />
                  </AccordionTrigger>
                  <AccordionContent isOpen={isOpen}>
