// Package spotlight is the Go stub for the "spotlight" RoyCSS platform module.
//
// Spotlight routes — /api/v1/spotlight
//
// Status: STUB — mirrors backend-node/src/modules/spotlight.
...
// RegisterRoutes mounts the spotlight module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/spotlight", notImplemented)
	mux.HandleFunc("/api/v1/spotlight/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"spotlight"}}`))
}
