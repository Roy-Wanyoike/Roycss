...
server.setRequestHandler(ListToolsRequestSchema, async () => ({
  tools: [
    ...
    },
    {
      name: "get_collection",
      description:
        "Get a single RoyCSS collection by ID, including the full effect list with CSS code. Use after get_collections when you know the collection ID, or when a user asks for a specific aesthetic (e.g., 'give me the glassmorphism collection', 'show me neon effects').",
      inputSchema: {
        type: "object",
        properties: {
    ...
    switch (name) {
      ...
      case "get_collection": {
        ...
        const collectionEffects = collection.effectIds
          .map((eid) => EFFECTS.find((e) => e.id === eid))
