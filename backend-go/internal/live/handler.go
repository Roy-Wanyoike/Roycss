// Package live is the Go stub for the "live" RoyCSS platform module.
//
// Live routes — /api/v1/live
//
// Status: STUB — mirrors backend-node/src/modules/live.
...
// RegisterRoutes mounts the live module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/live", notImplemented)
	mux.HandleFunc("/api/v1/live/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"live"}}`))
}
