// Package themes is the Go stub for the "themes" RoyCSS platform module.
//
// Themes routes — /api/v1/themes
//
// Status: STUB — mirrors backend-node/src/modules/themes.
...
// RegisterRoutes mounts the themes module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/themes", notImplemented)
	mux.HandleFunc("/api/v1/themes/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"themes"}}`))
}
