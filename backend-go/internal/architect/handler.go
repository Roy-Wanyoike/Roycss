// Package architect is the Go stub for the "architect" RoyCSS platform module.
//
// Architect routes — /api/v1/architect
//
// Status: STUB — mirrors backend-node/src/modules/architect.
...
// RegisterRoutes mounts the architect module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/architect", notImplemented)
	mux.HandleFunc("/api/v1/architect/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"architect"}}`))
}
