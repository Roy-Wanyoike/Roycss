// Package open is the Go stub for the "open" RoyCSS platform module.
//
// Open routes — /api/v1/open
//
// Status: STUB — mirrors backend-node/src/modules/open.
...
// RegisterRoutes mounts the open module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/open", notImplemented)
	mux.HandleFunc("/api/v1/open/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"open"}}`))
}
