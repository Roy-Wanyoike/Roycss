// Package logicalproperties is the Go stub for the "logical-properties" RoyCSS platform module.
//
// Logical-properties routes — /api/v1/logical-properties
//
// Status: STUB — mirrors backend-node/src/modules/logical-properties.
...
package logicalproperties

import (
	"net/http"
)

// RegisterRoutes mounts the logical-properties module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/logical-properties", notImplemented)
	mux.HandleFunc("/api/v1/logical-properties/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"logical-properties"}}`))
}
