// Package initialletter is the Go stub for the "initial-letter" RoyCSS platform module.
//
// Initial-letter routes — /api/v1/initial-letter
//
// Status: STUB — mirrors backend-node/src/modules/initial-letter.
...
// RegisterRoutes mounts the initial-letter module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/initial-letter", notImplemented)
	mux.HandleFunc("/api/v1/initial-letter/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"initial-letter"}}`))
}
