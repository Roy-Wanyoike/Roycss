// Package enterprise is the Go stub for the "enterprise" RoyCSS platform module.
//
// Enterprise routes — /api/v1/enterprise
//
// Status: STUB — mirrors backend-node/src/modules/enterprise.
...
// RegisterRoutes mounts the enterprise module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/enterprise", notImplemented)
	mux.HandleFunc("/api/v1/enterprise/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"enterprise"}}`))
}
