// Package compliance is the Go stub for the "compliance" RoyCSS platform module.
//
// Compliance routes — /api/v1/compliance
//
// Status: STUB — mirrors backend-node/src/modules/compliance.
...
// RegisterRoutes mounts the compliance module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/compliance", notImplemented)
	mux.HandleFunc("/api/v1/compliance/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"compliance"}}`))
}
