// Package marketplace is the Go stub for the "marketplace" RoyCSS platform module.
//
// Marketplace routes — /api/v1/marketplace
//
// Status: STUB — mirrors backend-node/src/modules/marketplace.
...
// RegisterRoutes mounts the marketplace module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/marketplace", notImplemented)
	mux.HandleFunc("/api/v1/marketplace/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"marketplace"}}`))
}
