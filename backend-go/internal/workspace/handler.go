// Package workspace is the Go stub for the "workspace" RoyCSS platform module.
//
// Workspace routes — /api/v1/workspace
//
// Status: STUB — mirrors backend-node/src/modules/workspace.
...
// RegisterRoutes mounts the workspace module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/workspace", notImplemented)
	mux.HandleFunc("/api/v1/workspace/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"workspace"}}`))
}
