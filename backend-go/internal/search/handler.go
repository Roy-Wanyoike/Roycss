// Package search is the Go stub for the "search" RoyCSS platform module.
//
// Search routes — /api/v1/search
//
// Status: STUB — mirrors backend-node/src/modules/search.
...
// RegisterRoutes mounts the search module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/search", notImplemented)
	mux.HandleFunc("/api/v1/search/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"search"}}`))
}
