...
export function GET() {
  ...
  <text x="600" y="400" font-family="system-ui, sans-serif" font-size="20" fill="#6b7280" text-anchor="middle">1,569 Effects · 62 Products · 64 DevTools · AI Assistance</text>
