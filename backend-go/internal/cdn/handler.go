// Package cdn is the Go stub for the "cdn" RoyCSS platform module.
//
// CDN routes — /api/v1/cdn
//
// Status: STUB — mirrors backend-node/src/modules/cdn.
...
// RegisterRoutes mounts the cdn module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/cdn", notImplemented)
	mux.HandleFunc("/api/v1/cdn/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"cdn"}}`))
}
