// Package designer is the Go stub for the "designer" RoyCSS platform module.
//
// Designer routes — /api/v1/designer
//
// Status: STUB — mirrors backend-node/src/modules/designer.
...
// RegisterRoutes mounts the designer module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/designer", notImplemented)
	mux.HandleFunc("/api/v1/designer/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"designer"}}`))
}
