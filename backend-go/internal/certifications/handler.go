// Package certifications is the Go stub for the "certifications" RoyCSS platform module.
//
// Certifications routes — /api/v1/certifications
//
// Status: STUB — mirrors backend-node/src/modules/certifications.
...
// RegisterRoutes mounts the certifications module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/certifications", notImplemented)
	mux.HandleFunc("/api/v1/certifications/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"certifications"}}`))
}
