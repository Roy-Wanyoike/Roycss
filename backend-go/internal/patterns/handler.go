// Package patterns is the Go stub for the "patterns" RoyCSS platform module.
//
// Patterns routes — /api/v1/patterns
//
// Status: STUB — mirrors backend-node/src/modules/patterns.
...
// RegisterRoutes mounts the patterns module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/patterns", notImplemented)
	mux.HandleFunc("/api/v1/patterns/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"patterns"}}`))
}
