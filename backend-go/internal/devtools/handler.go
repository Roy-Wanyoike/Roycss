// Package devtools is the Go stub for the "devtools" RoyCSS platform module.
//
// DevTools routes — /api/v1/devtools
//
// Status: STUB — mirrors backend-node/src/modules/devtools.
...
// RegisterRoutes mounts the devtools module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/devtools", notImplemented)
	mux.HandleFunc("/api/v1/devtools/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"devtools"}}`))
}
