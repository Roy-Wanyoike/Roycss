// Package edge is the Go stub for the "edge" RoyCSS platform module.
//
// Edge routes — /api/v1/edge
//
// Status: STUB — mirrors backend-node/src/modules/edge.
...
// RegisterRoutes mounts the edge module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/edge", notImplemented)
	mux.HandleFunc("/api/v1/edge/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"edge"}}`))
}
