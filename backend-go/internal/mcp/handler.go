// Package mcp is the Go stub for the "mcp" RoyCSS platform module.
//
// MCP routes — /api/v1/mcp
//
// Status: STUB — mirrors backend-node/src/modules/mcp.
...
// RegisterRoutes mounts the mcp module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/mcp", notImplemented)
	mux.HandleFunc("/api/v1/mcp/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"mcp"}}`))
}
