// Package scaffold is the Go stub for the "scaffold" RoyCSS platform module.
//
// Scaffold routes — /api/v1/scaffold
//
// Status: STUB — mirrors backend-node/src/modules/scaffold.
...
// RegisterRoutes mounts the scaffold module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/scaffold", notImplemented)
	mux.HandleFunc("/api/v1/scaffold/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"scaffold"}}`))
}
