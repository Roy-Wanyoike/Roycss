// Package auth is the Go stub for the "auth" RoyCSS platform module.
//
// Auth routes — /api/v1/auth
//
// Status: STUB — mirrors backend-node/src/modules/auth.
...
// RegisterRoutes mounts the auth module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/auth", notImplemented)
	mux.HandleFunc("/api/v1/auth/", notImplemented)
}
