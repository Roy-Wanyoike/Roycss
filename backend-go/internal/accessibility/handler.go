// Package accessibility is the Go stub for the "accessibility" RoyCSS platform module.
//
// Accessibility routes — /api/v1/accessibility
//
// Status: STUB — mirrors backend-node/src/modules/accessibility.
...
// RegisterRoutes mounts the accessibility module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/accessibility", notImplemented)
	mux.HandleFunc("/api/v1/accessibility/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"accessibility"}}`))
}
