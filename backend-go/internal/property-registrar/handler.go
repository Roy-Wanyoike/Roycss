// Package propertyregistrar is the Go stub for the "property-registrar" RoyCSS platform module.
//
// Property-registrar routes — /api/v1/property-registrar
//
// Status: STUB — mirrors backend-node/src/modules/property-registrar.
...
package propertyregistrar

import (
	"net/http"
)

// RegisterRoutes mounts the property-registrar module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/property-registrar", notImplemented)
	mux.HandleFunc("/api/v1/property-registrar/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"property-registrar"}}`))
}
