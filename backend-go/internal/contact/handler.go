// Package contact is the Go stub for the "contact" RoyCSS platform module.
//
// Contact routes — /api/v1/contact
//
// Status: STUB — mirrors backend-node/src/modules/contact.
...
// RegisterRoutes mounts the contact module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/contact", notImplemented)
	mux.HandleFunc("/api/v1/contact/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"contact"}}`))
}
