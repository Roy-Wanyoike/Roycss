// Package generator is the Go stub for the "generator" RoyCSS platform module.
//
// Generator routes — /api/v1/generator
//
// Status: STUB — mirrors backend-node/src/modules/generator.
...
// RegisterRoutes mounts the generator module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/generator", notImplemented)
	mux.HandleFunc("/api/v1/generator/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"generator"}}`))
}
