// Package fleet is the Go stub for the "fleet" RoyCSS platform module.
//
// Fleet routes — /api/v1/fleet
//
// Status: STUB — mirrors backend-node/src/modules/fleet.
...
// RegisterRoutes mounts the fleet module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/fleet", notImplemented)
	mux.HandleFunc("/api/v1/fleet/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"fleet"}}`))
}
