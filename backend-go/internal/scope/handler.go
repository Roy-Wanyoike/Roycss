// Package scope is the Go stub for the "scope" RoyCSS platform module.
//
// Scope routes — /api/v1/scope
//
// Status: STUB — mirrors backend-node/src/modules/scope.
...
// RegisterRoutes mounts the scope module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/scope", notImplemented)
	mux.HandleFunc("/api/v1/scope/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"scope"}}`))
}
