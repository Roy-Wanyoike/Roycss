// Package benchmark is the Go stub for the "benchmark" RoyCSS platform module.
//
// Benchmark routes — /api/v1/benchmark
//
// Status: STUB — mirrors backend-node/src/modules/benchmark.
...
// RegisterRoutes mounts the benchmark module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/benchmark", notImplemented)
	mux.HandleFunc("/api/v1/benchmark/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"benchmark"}}`))
}
