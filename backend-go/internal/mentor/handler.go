// Package mentor is the Go stub for the "mentor" RoyCSS platform module.
//
// Mentor routes — /api/v1/mentor
//
// Status: STUB — mirrors backend-node/src/modules/mentor.
...
// RegisterRoutes mounts the mentor module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/mentor", notImplemented)
	mux.HandleFunc("/api/v1/mentor/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"mentor"}}`))
}
