// Package preview is the Go stub for the "preview" RoyCSS platform module.
//
// Preview routes — /api/v1/preview
//
// Status: STUB — mirrors backend-node/src/modules/preview.
...
// RegisterRoutes mounts the preview module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/preview", notImplemented)
	mux.HandleFunc("/api/v1/preview/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"preview"}}`))
}
