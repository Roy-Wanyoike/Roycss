// Package motion is the Go stub for the "motion" RoyCSS platform module.
//
// Motion routes — /api/v1/motion
//
// Status: STUB — mirrors backend-node/src/modules/motion.
...
// RegisterRoutes mounts the motion module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/motion", notImplemented)
	mux.HandleFunc("/api/v1/motion/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"motion"}}`))
}
