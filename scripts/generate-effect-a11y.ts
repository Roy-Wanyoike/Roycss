 ...
 *
 * Derives per-effect accessibility tags from the 1,983-effect catalog
 * (src/lib/effects-batch-{1..54}.ts, imported through src/lib/roycss-effects.ts)
 ...
 * re-derivation, and a file-level grep of the 54 batch sources), so CI
...
function main() {
  ...
  lines.push(" *");
  lines.push(" * Source: the 1,983-effect catalog (src/lib/effects-batch-{1..54}.ts via");
  ...
  lines.push(" *   - CSSEffect (src/lib/roycss-types.ts) is deliberately UNTOUCHED. The 53");
