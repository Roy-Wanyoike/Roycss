...
const RECIPES: Record<string, { title: string; description: string; effects: string[]; html: string }> = {
  "hero-section": {
    title: "Hero Section",
    description: "A modern hero section with animated gradient text, glassmorphism card, and shine button",
    effects: ["text-aurora-gradient-b18", "card-glass-hover", "btn-gradient-glow-b18"],
    html: `<section class="hero">
  <h1 class="roycss-text-aurora-gradient-b18">Build Beautiful UIs</h1>
  <div class="roycss-card-glass-hover">
    <p>Production-ready CSS effects, zero JavaScript.</p>
    <button class="roycss-btn-gradient-glow-b18">Get Started</button>
  </div>
</section>`,
  },
  "loading-state": {
    title: "Loading State",
    description: "Three loading indicators for different use cases",
    effects: ["loader-dots-bounce", "loader-ring-spin", "loader-pulse-circle"],
    html: `<div class="loading-state">
  <div class="roycss-loader-dots-bounce">
    <span></span><span></span><span></span>
  </div>
  <div class="roycss-loader-ring-spin"></div>
  <div class="roycss-loader-pulse-circle"></div>
</div>`,
  },
  "feature-cards": {
    title: "Feature Cards Grid",
    description: "A grid of feature cards with hover lift and glow effects",
    effects: ["hover-lift-glow-b18", "vis-frosted-glass-v2-b18", "glass-badge-pill-b18"],
    html: `<div class="features-grid">
  <div class="roycss-hover-lift-glow-b18">
    <div class="roycss-vis-frosted-glass-v2-b18">
  ...
  "notification-badge": {
    ...
    description: "Pulsing notification indicator with attention animation",
  ...
  "glass-navigation": {
    ...
    description: "A floating glassmorphism navigation bar with badge pills",
    effects: ["glass-nav-bar-b18", "glass-badge-pill-b18", "btn-glass-press-b18"],
    html: `<nav class="roycss-glass-nav-bar-b18">
  <span class="roycss-glass-badge-pill-b18">Home</span>
  <button class="roycss-btn-glass-press-b18">Dashboard</button>
</nav>`,
  },
};
