// Package version is the Go stub for the "version" RoyCSS platform module.
//
// Version routes — /api/v1/version
//
// Status: STUB — mirrors backend-node/src/modules/version.
...
// RegisterRoutes mounts the version module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/version", notImplemented)
	mux.HandleFunc("/api/v1/version/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"version"}}`))
}
