// Package stylequery is the Go stub for the "style-query" RoyCSS platform module.
//
// Style-query routes — /api/v1/style-query
//
// Status: STUB — mirrors backend-node/src/modules/style-query.
...
// RegisterRoutes mounts the style-query module's routes on the given mux.
// All routes return 501 until the Go implementation is completed.
func RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("/api/v1/style-query", notImplemented)
	mux.HandleFunc("/api/v1/style-query/", notImplemented)
}
...
func notImplemented(w http.ResponseWriter, _ *http.Request) {
	...
	_, _ = w.Write([]byte(`{"error":{"code":"NOT_IMPLEMENTED","message":"Go stub — use backend-node for this module","module":"style-query"}}`))
}
